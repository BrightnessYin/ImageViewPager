 ...
 */
class SwipeBackLayout1 extends ViewGroup {
    ...
    public SwipeBackLayout1(Context context) {
        this(context, null);
    }

    public SwipeBackLayout1(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void smoothScrollToX(int finalLeft) {
        if (viewDragHelper.settleCapturedViewAt(finalLeft, 0)) {
            ViewCompat.postInvalidateOnAnimation(SwipeBackLayout1.this);
        }
    }
